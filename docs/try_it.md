...
### Install Haskell
You will need **GHC 8.0.2 - 8.10.7**. I recommend using [ghcup](https://www.haskell.org/ghcup/) to get it. If you wish to use a later version of Haskell, please see [these instructions](haskell9.html).
